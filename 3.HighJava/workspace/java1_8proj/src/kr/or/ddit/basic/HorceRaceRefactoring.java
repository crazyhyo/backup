...
public class HorceRaceRefactoring {
    ...
    public static void main(String[] args) {
    	...
    	horseList.stream().forEach(s->s.start());
    	...
    	while(recordList.size() != horseList.size()) {
    		horseList.stream().forEach(s->System.out.println(s.getView()));
    		System.out.println("===============================================================");
    		try {
    			Thread.sleep(100);
    	...
    	horseList.stream().forEach(s->s.setRank());
    	
    	horseList = horseList.stream().sorted().collect(Collectors.toList());
    	
    	horseList.stream().forEach(s->System.out.println(s));
    } 
}
