...
//            System.out.println("------------------------------------------------");
            ...
            MemberVO mv2 = new MemberVO("d001", "조명석", "444-3333", "대전시 중구");
//            mv2.setMemId("d001");
//            mv2.setMemName("조명석");
...
//            mv2.setMemAddr("대전시 중구");
            ...
            // 2) 응답의 결과가 한개인 경우...
            System.out.println("select연습(결과가 한개인 경우...)");

            
            // 응답 결과가 1개가 확실한 경우에는 queryForObject메서드를 이용한다.
            MemberVO mv3 = (MemberVO)smc.queryForObject("memberTest.getMember", "tmp1");
