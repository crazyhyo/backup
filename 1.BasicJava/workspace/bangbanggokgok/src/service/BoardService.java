...
public class BoardService {
	...
	public static int noticeBoardDetail() {
		...
		case 2: if(boardDao.deleteBoard(2) == 0) {
	...
	public static int reviewBoardDetail() {
		System.out.println("REVIEW_BOARD_DETAIL");
		showCurrentBoard(1);
		...
		case 2: if(boardDao.deleteBoard(1) == 0) {
...
//				+ boardDetail.get("MEM_NM"));
				System.out.println("작성일 : " + boardDetail.get("BOD_REG_DATE"));
...
//				+ boardDetail.get("MEM_NM"));
	...
	public static int noticeBoardList() {
		System.out.println("NOTICE_BOARD_LIST");
		...
		for(Map<String, Object> walk : list){
			...
			System.out.println("작성자 :\t\t\t관리자");
			System.out.println("작성일 :" + "\t\t\t" + walk.get("BOD_REG_DATE"));
			System.out.println("-------------------------------------------------");
		}
	...
	public static int reviewBoardList() {
		System.out.println("REVIEW_BOARD_LIST");
		List<Map<String, Object>> list = null;
		list = boardDao.currentLodgeBoardList(1);
		
		for(Map<String, Object> walk : list){
			System.out.println((String.valueOf(walk.get("BOD_RATING"))));
			System.out.println("게시글번호 :" + "\t\t\t" + walk.get("BOD_NO"));
			System.out.println("제목 :" + "\t\t\t" + walk.get("BOD_TITLE"));
			System.out.println("작성자 :" + "\t\t\t" + walk.get("MEM_NM"));
			System.out.println("평점 :" + "\t\t\t" + Double.parseDouble((String.valueOf(walk.get("BOD_RATING")))));
			System.out.println("작성일 :" + "\t\t\t" + walk.get("BOD_REG_DATE"));
			System.out.println("-------------------------------------------------");
		}
