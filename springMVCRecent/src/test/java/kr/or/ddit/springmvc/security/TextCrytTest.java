...
//		String testString = "This is ...";
		...
		try {
			...
			String encoding = Base64.getEncoder().encodeToString(encrypted);
			LOGGER.info("encoding: "+encoding);
			LOGGER.info("decrypted: "+new String(cryptoService.decrypt(Base64.getDecoder().decode(encoding), password), "UTF-8"));
