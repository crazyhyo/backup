 ...
 * Generated at: 2021-10-27 05:10:20 UTC
...
/* 	if(boardCodeNo == null){
	...
	if(loginMember != null){
      ...
      out.write("        \t\t//alert(boardCodeNo + \"번 게시판 코드에 댓글\")\r\n");
      out.write("        \t\t//alert(memNo + \"번 등록할 아이디\")\r\n");
      out.write("        \t\t\r\n");
      ...
      out.write("        \t\tconsole.log(reply.boardCodeNo);\r\n");
      out.write("        \t\t\r\n");
 ...
 for(Map<String, Object> vo : boardList){
      ...
      out.write("\t\t\t\t\t        \t\t<i class=\"far fa-eye\"></i>&nbsp;<span class=\"board-view board-sm-font\" id=\"board-hit-");
      out.print( vo.get("BOARD_HIT") );
      out.write('"');
      out.write('>');
      out.print( vo.get("BOARD_HIT") );
      out.write("</span>&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t        \t\t<i class=\"far fa-thumbs-up\"></i>&nbsp;<span class=\"board-like board-sm-font\" id=\"board-like-");
      out.print( vo.get("BOARD_LIKE") );
      out.write('"');
      out.write('>');
      out.print( vo.get("BOARD_LIKE") );
      out.write("</span>&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t        \t\t<i class=\"far fa-comment\"></i>&nbsp;<span class=\"board-comment board-sm-font\" id=\"board-reply-");
