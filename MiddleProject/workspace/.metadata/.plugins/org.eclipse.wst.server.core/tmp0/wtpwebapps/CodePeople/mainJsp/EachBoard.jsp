		                ...
		                <div class="card">
			        		<div class="card-header">
				        		...
				        		<div class="board-icon-box">
					        		<i class="far fa-eye"></i>&nbsp;<span class="board-view board-sm-font" id="board-hit-<%= vo.get("BOARD_HIT") %>"><%= vo.get("BOARD_HIT") %></span>&nbsp;&nbsp;
					        		<i class="far fa-thumbs-up"></i>&nbsp;<span class="board-like board-sm-font" id="board-like-<%= vo.get("BOARD_LIKE") %>"><%= vo.get("BOARD_LIKE") %></span>&nbsp;&nbsp;
					        		<i class="far fa-comment"></i>&nbsp;<span class="board-comment board-sm-font" id="board-reply-<%= vo.get("BOARD_REPL") %>"><%= vo.get("BOARD_REPL") %></span>&nbsp;&nbsp;
				        		</div>
			        		</div>
