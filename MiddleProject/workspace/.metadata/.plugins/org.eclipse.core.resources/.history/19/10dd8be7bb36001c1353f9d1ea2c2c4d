...
<%
  MemberVO vo = (MemberVO) session.getAttribute("memVO");
 	...
 	int memCode = 0; // 비회원
	int isApi = vo.getMemIsApi();	 // 기본값 : 0, 외부로그인 : 1
	String myPage = "";
            ...
            <div class="col-md-10 mx-auto col-lg-5">
              <form class="p-4 p-md-5 border rounded-3 bg-light">
                <div class="profile">
                  ...
                  <a href="<%=myPage%>">
                    <img id="profile-img" class="ui circular image" src="/CodePeople/images/doge1.jpg" alt="프로필이미지">
                    <p class="profile-name"><%=vo.getMemId() %></p>
                  </a>
                  <!-- <p class="nowrap meta">
        ...
        <div class="mt-5 text-center">
          ...
          <div class="col-lg-6 mx-auto">
            ...
            <div class="d-grid gap-2 justify-content-sm-center">
              <div class="user-list">
                ...
                <div class="item">
                  ...
                  <p class="nowrap meta">
                    ...
                    <a href="/companies/naver">@고고IT회사</a>
                  </p>
                  <p class="break testimonial">
                    Tôi không nói được tiếng Hàn. Xin chào. Rất vui được gặp bạn. Tôi học hôm nay. tôi yêu bạn cái đuôi.
                  </p>
                </div>
                ...
                <div class="item">
                  ...
                  <p class="break testimonial">
                    Google is the best. simpley say, there is no company can follow Google's convenience. Apple? poo~ (laughing)
                  </p>
                </div>
              </div>
              ...
              <div class="item">
                <a href="https://company.netmarble.com/">
                  <img class="ui circular image" src="https://yt3.ggpht.com/ytc/AKedOLQPAS_G53xcUdaKZtbdnZEC6zx_wdd3GCVhhstR0Q=s900-c-k-c0x00ffffff-no-rj" alt="넷마블">
                  <p class="name">넷마블</p>
                </a>
                <p class="break testimonial">
              ...
              <div class="item">
                ...
                <p class="break testimonial">
                  네이버 주식회사는 No. 1 검색 포털 네이버, 국내 최초 어린이 전용 포털 쥬니어네이버,
