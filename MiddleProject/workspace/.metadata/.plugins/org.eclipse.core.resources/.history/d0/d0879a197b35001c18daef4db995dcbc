package kr.or.ddit.jobOpening.vo;

public class JOCardVO {
	private String comNm;
	private String comHpg;
	private Integer comFav = 0;
	...
	private String cityCodeNm;
	private String provCodeNm;
	private Integer joNo = 0;
	public Integer getJoSal() {
		return joSal;
	}
	public void setJoSal(Integer joSal) {
		this.joSal = joSal;
	}
	...
	public String getComHpg() {
		return comHpg;
	}
	public void setComHpg(String comHpg) {
		this.comHpg = comHpg;
	}
	public Integer getComFav() {
		return comFav;
	}
	public void setComFav(Integer comFav) {
		this.comFav = comFav;
	}
	...
	public Integer getJoClip() {
		return joClip;
	}
	public void setJoClip(Integer joClip) {
		this.joClip = joClip;
	}
	public String getJoMthd() {
		return joMthd;
	}
	public void setJoMthd(String joMthd) {
		this.joMthd = joMthd;
	}
	...
	public String getJoRank() {
		return joRank;
	}
	public void setJoRank(String joRank) {
		this.joRank = joRank;
	}
	...
	public String getJoEdate() {
		return joEdate;
	}
	public void setJoEdate(String joEdate) {
		this.joEdate = joEdate;
	}
	public String getCityCodeNm() {
		return cityCodeNm;
	}
	public void setCityCodeNm(String cityCodeNm) {
		this.cityCodeNm = cityCodeNm;
	}
	public String getProvCodeNm() {
		return provCodeNm;
	}
	public void setProvCodeNm(String provCodeNm) {
		this.provCodeNm = provCodeNm;
	}
