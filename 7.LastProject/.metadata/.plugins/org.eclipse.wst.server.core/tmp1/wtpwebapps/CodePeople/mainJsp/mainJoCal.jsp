		...
		<div id="body-container">
			...
			<div class="nav-left-bar">
				<div class="nav-sticky">
					<ul class="list-group">
						<a href="/CodePeople/mainJsp/mainJO.jsp"><li class="list-group-item" id="">채용 공고</li></a>
			...
			<div id="content">
				...
				<div class="content-box search-result jo" id="result-card-list">
					...
					<div class="filter-box content-box jo">
						...
						<div class="filter-box-dropdowns">
							<div class="dropdown">
								<button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">스크랩한 공채
									보기</button>
								<ul class="dropdown-menu"></ul>
							</div>
							<div class="dropdown">
								<button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">관심기업 공채
									보기</button>
								<ul class="dropdown-menu"></ul>
							</div>
							<div class="dropdown">
							...
							<div class="dropdown">
								<button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">마감일
									펼쳐보기</button>
								<ul class="dropdown-menu"></ul>
							</div>
						</div>
					</div>
					<iframe src="/CodePeople/MainJoCal.do" name="calendar" width="2000" height="750">
					</iframe>
				</div>
