						...
						<div class="content-box search-result board board-main board-life">
							<div class="board-header">
								...
								<div class="board-btn-box">
									<a href="/CodePeople/rehearsal/boardLife.html"><button
							...
							<div class="board-card">
								<div class="board-detail">
									<a href="/CodePeople/rehearsal/boardLife.html"
										class="card-link"><span class="board-title">회사 때려치고
											싶어요</span></a>&nbsp;&nbsp;
									<div class="view-box">
							...
							<div class="board-card">
								<div class="board-detail">
									<a href="/CodePeople/rehearsal/boardLife.html"
										class="card-link"><span class="board-title">프론트 적성에
											안맞아요</span></a>&nbsp;&nbsp;
									<div class="view-box">
										<i class="far fa-eye"></i>&nbsp;<span
											class="board-view board-sm-font">100</span>
							...
							<div class="board-card">
								<div class="board-detail">
									<a href="/CodePeople/rehearsal/boardLife.html"
										class="card-link"><span class="board-title">에라 모르겠다</span></a>&nbsp;&nbsp;
									<div class="view-box">
										<i class="far fa-eye"></i>&nbsp;<span
											class="board-view board-sm-font">100</span>
									</div>
									...
									<div class="card-jobs-detail">
										...
										<div class="jobs-detail-top">
											<div class="jobs-detail">
												<a href="#" class="card-link"><span class="jo-title">
				...
				<div id="news"
					...
					<div class="my-box-item">
						...
						<div class="content-box search-result board board-main board-best">
							...
							<div class="board-card">
								<div class="board-detail">
									<a href="#" class="card-link"><span class="board-title">충격,
											"네이버 망하다."</span></a>&nbsp;&nbsp;
									<div class="view-box">
										<i class="far fa-eye"></i>&nbsp;<span
											class="board-view board-sm-font">2021-9-28</span>
									</div>
								</div>
							</div>
							<!-- 시연을 위한 코드입니다 우측 카드를 사용해주세요 -->
							<div class="board-card">
								<div class="board-detail">
									<a href="#" class="card-link"><span class="board-title">네이버,
											주가폭락</span></a>&nbsp;&nbsp;
									<div class="view-box">
										<i class="far fa-eye"></i>&nbsp;<span
											class="board-view board-sm-font">2021-10-21</span>
									</div>
								</div>
							</div>
							<div class="board-card">
								<div class="board-detail">
									<a href="#" class="card-link"><span class="board-title">NC김택진,
											사퇴의사밝혀</span></a>&nbsp;&nbsp;
									<div class="view-box">
										<i class="far fa-eye"></i>&nbsp;<span
											class="board-view board-sm-font">2021-3-25</span>
									</div>
								</div>
							</div>
						</div>
