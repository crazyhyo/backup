        ...
        <div class="content-box search-result board board-main" id="report-box">
          ...
          <div class="board-body">
            ...
            <div id="accordion">
                ...
                <div id="collapseOne" class="collapse " data-bs-parent="#accordion">
                  <div class="card-body">
                    ...
                    <div class="my-btn-box my-btn-box-cv">
                      <button type="button" class="btn btn-outline-primary">신고사유</button>
                  ...
                  <div class="reply-box">
                    ...
                    <div class="reply-card bg-light text-dark">
                      ...
                      <div class="card-body"><span class="reply-content">이것은 댓글입니다. 드랍 박스내부에 대댓글을 항목으로 넣어 구현할까 생각 중이에요.
                          그리고 추천과 신고 대댓글 갯수를 넣으려면, 게시글 위에 보이는 이미지들을 또 쓰겠죠.....그리고 수정 삭제도 드랍박스 안에 넣을 꺼에요.아 모르겠다 이제 ㄴ일 해야지
                          모두들 꿋잠...</span></div>
              ...
              <div class="card">
                <div class="card-header">
                  <a class="btn title-btn" data-bs-toggle="collapse" href="#collapseTwo">
                    <span class="board-detail-title">회사 다니기 싫다.</span>
                  </a>
                  <div class="board-icon-box">
                    <i class="far fa-eye"></i>&nbsp;<span class="board-view board-sm-font">100</span>&nbsp;&nbsp;
