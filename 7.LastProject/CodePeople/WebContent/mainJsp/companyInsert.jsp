...
<%
	...
	if(SessionCheck.isLoginMember(session)){
		...
		if(memCode == 1){
			...
			%> <script>	alert("기업 회원만 이용 가능합니다.")
						location.href="/CodePeople/CompanyPagingList.do" </script> <%
		}else if(memCode == 2){
	...
	<div class="container mt-3 formsizing company-register">
		...
		<form action="/action_page.php" id="comInsert">
			...
			<div class="btn-center-box">
				<button type="button" class="btn btn-primary btn-lg" id="upd-btn">수정</button>
				<button type="button" class="btn btn-primary btn-lg" id="del-btn">삭제</button>
			</div>
		</form>
	...
	<div class="container mt-3 formsizing company-register">
		...
		<form action="/action_page.php" id="comInsert">
			<div class="mb-3 mt-3">
				<label>한글 기업명</label> <br> <label class="la2" for="email">*&nbsp;주식회사,
					(주) 등의 표기 없이 입력해주세요</label> <input type="text" class="form-control"
					id="name" placeholder="예) 기업명 " name="comNm">
			</div>

			<div class="mb-3">
				<label>사원 수</label> <input type="number" class="form-control"
					id="emp" placeholder="사원 수를 입력해주세요.('명'은 생략)" name="comCnt"">
			</div>

			<div class="mb-3">
				<label>홈페이지 주소</label> <input type="url" class="form-control"
					id="company" placeholder="홈페이지 주소를 입력해주세요" name="comHpg">
			</div>

			<div class="mb-3">
				<label>평균 연봉</label> <input type="text" class="form-control"
					id="salary" placeholder="평균 연봉을 입력해주세요.('만 원'은 생략)" name="comSal">
			</div>

			<div class="mb-3">
				<label>설립일</label> <input type="date" class="form-control"
					id="company-date" placeholder="설립일을 입력해주세요." name="comDate">
			</div>

			<div class="mb-3">
				<label>회사 한줄 소개</label> <input type="text" class="form-control"
					id="introdce" placeholder="회사 한줄 소개를 입력해주세요." name="comIntro">
			</div>
			...
			<div class="btn-center-box">
				<button type="button" class="btn btn-primary btn-lg" id="cpn-btn">등록</button>
			</div>
		</form>
