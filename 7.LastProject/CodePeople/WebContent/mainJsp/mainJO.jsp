		...
		<div id="body-container">
			...
			<div class="nav-left-bar">
				<div class="nav-sticky">
					<ul class="list-group">
						<a href="/CodePeople/mainJsp/mainJO.jsp"><li class="list-group-item active" id="">채용 공고</li></a>
							...
							<div class="card-jobs-detail">
								...
								<div class="jobs-detail-top">
									<div class="jobs-detail">
										...
										<span class="jo-salary jo-sm-font">${JO_SAL_TYPE}</span> <span class="jo-sm-font">/</span> <span
