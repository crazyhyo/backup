...
import egovframework.example.util.CmmnUtil;
...
//	import org.slf4j.LoggerFactory;
	...
	public String selectSampleList(@ModelAttribute("searchVO") SampleDefaultVO searchVO, ModelMap model)
		...
		for (Object object : sampleList) {
			...
			String id = MapUtils.getString(item, "id", "00000000");

			LOGGER.debug("item : {}", item);

			CmmnUtil.createQrCode(String.format("http:192.168.143.22:8787/login.do?key=%s", id), id);
